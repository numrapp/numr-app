...
function generateInvoicePDF(data) {
    return new Promise((resolve, reject) => {
        ...
        doc.font('Helvetica').text(data.supplierIban, vx, contactY);
        contactY += 13;
        doc.font('Helvetica-Bold').text('Btw-nr', rx, contactY);
        doc.font('Helvetica').text(data.supplierBtw, vx, contactY);
        contactY += 13;
